            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-password-image"><img src="img/desk2.jpg" ></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Modify Membership Information?</h1>
                                        <p class="mb-4">Just enter your password and name and nickname below 
                                            and we'll modify your information!</p>
                                    </div>
                                    <form class="user" action = "ModifyCon" method = "post">
                                        
                                           <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                   id="user_pw" aria-describedby="emailHelp" name = "user_pw"
