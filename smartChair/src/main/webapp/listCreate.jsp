					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							<div
								...
								</a> <a class="dropdown-item" href="modify.jsp"> <i
									class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> Modify
								</a>
					...
					<div class="card-body">
						<form action="articleWriteCon" method="post"
							...
							<table border="1px solid black"
								...
								<tr>
									<th class="w-px160" style="text-align: center;">제목</th>
									<td><input type="text" name="title" class="need"
										style="width: 100%" /></td>
								</tr>
								<tr>
