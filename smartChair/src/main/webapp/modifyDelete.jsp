...
<head>
    ...
    <title>MESSIAH - modifyDelete</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5" >
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Delete member information</h1>
                                    </div>
                                    <form class="userDelete" action = "delete.jsp" method="post">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="user_id" aria-describedby="emailHelp"
                                                placeholder="Enter Email Address..." name = "user_id">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="user_pw" placeholder="Password" name = "user_pw">
                                        </div>
                                        
                                        <input type="submit" name= "delete" class="btn btn-primary btn-user btn-block" value="Delete">
                                    </form>
                                    <hr>
